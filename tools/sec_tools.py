...
class SecTools():
  ...
  def sec_nvda(question):
    ...
    The input to this tool should be the question to be answered. For example, what does Nvdia do to earn money? What are some negative events that will affect the company? What are the negative views?
    """
  ...
  def sec_amd(question):
    ...
    The input to this tool should be the question to be answered. For example, what does AMD do to earn money? What are some negative events that will affect the company? What are the negative views?
    """
